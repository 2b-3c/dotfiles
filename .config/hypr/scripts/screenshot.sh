...
# Usage: screenshot.sh [smart|region|windows|fullscreen] [slurp|clip]
...
smart | *)
  ...
  # If the selection area is L * W < 20, assume click on a window/output
...
if [[ $PROCESSING == "slurp" ]]; then
  ...
  (
    ACTION=$(notify-send "Screenshot saved" "Saved to clipboard and file. Click to edit." -t 10000 -i "$FILEPATH" -A "default=edit")
