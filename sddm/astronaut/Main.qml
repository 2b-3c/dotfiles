...
Pane {
    ...
    Item {
        ...
        AnimatedImage {
            ...
            height: parent.height
            width: leftleft || rightright ? parent.width - formBackground.width : parent.width
            anchors.left: leftleft ? formBackground.right : undefined
            anchors.right: rightright ? formBackground.left : undefined
